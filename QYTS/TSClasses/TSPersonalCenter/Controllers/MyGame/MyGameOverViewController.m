...
@interface MyGameOverViewController () <UITableViewDelegate, UITableViewDataSource, MyGameHeaderViewDelegate, MyGameOverCellDelegate>
...
@implementation MyGameOverViewController
...
- (TSNoGameTipsView *)noGameTipsView {
    if (!_noGameTipsView) {
        ...
        _noGameTipsView.dataType = DataTypeGame;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    MyGameOverCell *cell = [MyGameOverCell cellWithTableView:tableView];
    cell.delegate = self;
    if (RulesSelect5V5 == self.rulesSelect) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    MyGameGameDetailsViewController *detailsVC = [[MyGameGameDetailsViewController alloc] init];
    if (RulesSelect5V5 == self.rulesSelect) {
        ...
        MyGameOverListModel *gameOverListModel = self.game3DataArray[indexPath.row];
        detailsVC.matchId = gameOverListModel.matchId;
    }
